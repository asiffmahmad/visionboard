    ...
    <div style={{ background: '#0b0f19', color: '#f3f4f6', fontFamily: '"Inter", "Outfit", sans-serif', overflowX: 'hidden', minHeight: '100vh' }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .landing-fade { opacity: 0; transform: translateY(32px); transition: opacity 0.65s ease, transform 0.65s ease; }
        .landing-fade.show { opacity: 1; transform: translateY(0); }
        @keyframes pulse-glow { 0%,100%{opacity:0.35} 50%{opacity:0.75} }
        ...
        .float-el { animation: float-up 6s ease-in-out infinite; }
        .btn-cta {
        ...
        .btn-cta:hover { transform:translateY(-2px); box-shadow:0 14px 40px rgba(99,102,241,0.5); }
        .btn-outline {
          display:inline-flex; align-items:center; gap:8px;
        ...
        .btn-outline:hover { background:rgba(255,255,255,0.09); border-color:rgba(255,255,255,0.3); transform:translateY(-1px); }
        .feat-card {
        ...
        .int-card:hover { background:rgba(255,255,255,0.06); transform:translateX(6px); border-color:rgba(255,255,255,0.18); }
        .stat-card {
        ...
        .stat-card:hover { background:rgba(99,102,241,0.08); border-color:rgba(99,102,241,0.3); transform:translateY(-2px); }
        .step-card {
        ...
        .mobile-nav-link {
          display:block; padding:14px 16px; color:#9ca3af;
          text-decoration:none; font-size:16px; font-weight:500;
          border-radius:10px; transition:all 0.2s;
        }
        .mobile-nav-link:hover { background:rgba(255,255,255,0.06); color:#f3f4f6; }
